...
ALTER TABLE dic.VAC_LIM
ADD foreign key (limit_type) references dic.limit(limit_type)
ALTER TABLE dic.VAC_LIM
ADD foreign key (vacation_type) references dic.vacation(vacation_type)
...
ALTER TABLE dic.conditions
ADD foreign key (Main_limit_type) references dic.limit(limit_type)
ALTER TABLE dic.conditions
ADD foreign key (Add_limit_type) references dic.limit(limit_type)
...
create table dbo.personal (
	TN				int not null identity(1, 1) primary key,
...
ADD CONSTRAINT chk_date CHECK (Date_from <= Date_to)
ALTER TABLE dbo.agreement
ADD foreign key (tn) references dbo.personal(tn)
...
(5, 100, '2023-03-01', '2023-03-14' ),
(7, 100, '2023-04-01', '2023-04-14' ),
(7, 200, '2023-04-15', '2023-04-18' ),
(8, 100, '2023-03-01', '2023-03-21' ),
(9, 100, '2023-03-01', '2023-03-14' ),
(10, 100, '2023-03-01', '2023-03-14' ),
(10, 100, '2023-04-01', '2023-04-14' ),
(10, 200, '2023-04-15', '2023-04-18' ),
(12, 100, '2023-03-01', '2023-03-21' ),
(15, 100, '2023-03-01', '2023-03-14' )
